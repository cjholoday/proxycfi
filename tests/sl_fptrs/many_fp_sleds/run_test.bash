...
cdi-gcc --make-sl=libtargetful1.so.1.0.0 targetful1.c
check "compilation of libtargetful1.so failed" || exit 1

cdi-gcc --make-sl=libtargetful2.so.1.0.0 targetful2.c
check "compilation of libtargetful2.so failed" || exit 1

cdi-gcc --use-sl=libtargetful1.so,libtargetful2.so main.c -o out
