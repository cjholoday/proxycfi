...
# purpose: generate unsafe (non-CDI) shared library and link with it

cdi_flags="-g --save-temps -fno-jump-tables"
tools_dir="$SCRIPT_DIR/../../../tools"
gen_sl="$tools_dir/gen_sl.bash"

"$gen_sl" libprint1.so print1.c
"$gen_sl" libprint2.so print2.c

cdi-gcc $cdi_flags main.c -L. libprint1.so libprint2.so -o out \
    -Wl,-rpath="$SCRIPT_DIR"
