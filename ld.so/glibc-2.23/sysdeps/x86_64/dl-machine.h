...
{
	_dl_debug_printf ("CDI --> 1 *reloc_addr = %x \n", (unsigned int)(*reloc_addr) );
...
# endif
					...
					case R_X86_64_JUMP_SLOT:
						_dl_debug_printf ("CDI --> 2 *reloc_addr = %x \n", (unsigned int)(*reloc_addr) );
...
#   else
							_dl_debug_printf ("CDI --> 3 *reloc_addr = %x \n", (unsigned int)(*reloc_addr) );
							*reloc_addr = value;
#   endif
						}
#  endif
...
#  ifdef __ILP32__
							...
							*(Elf64_Sxword *) reloc_addr = (Elf64_Sxword) (Elf32_Sword) value;
#  else
							_dl_debug_printf ("CDI --> 4 *reloc_addr = %x \n", (unsigned int)(*reloc_addr) );
							*reloc_addr = value;
#  endif
						}
						break;
...
#  endif
					case R_X86_64_IRELATIVE:
						...
						value = ((ElfW(Addr) (*) (void)) value) ();
						_dl_debug_printf ("CDI --> 5 *reloc_addr = %x \n", (unsigned int)(*reloc_addr) );
						*reloc_addr = value;
						break;
					default:
		...
		int skip_ifunc)
{
	...
	else if (__glibc_unlikely (r_type == R_X86_64_IRELATIVE))
	{
		...
		if (__glibc_likely (!skip_ifunc))
			value = ((ElfW(Addr) (*) (void)) value) ();
		_dl_debug_printf ("CDI --> 6 *reloc_addr = %x \n", (unsigned int)(*reloc_addr) );
		*reloc_addr = value;
	}
	else
