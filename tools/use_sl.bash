...
#
# This script will not compile the application code into CDI
# See use_cdi_sl.bash for that purpose
#
# Note that it is possible to link CDI code with a non-CDI shared
# library, but not with this script 
...
rm -f out
gcc -L"$libs_dir" -Wl,-rpath="$libs_dir" -g -Wall -o out --save-temps $gcc_args $libnames
