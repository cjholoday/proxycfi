...
pin_dir = "/home/misiker/Desktop/CDI-GCC/cdi/cdi-profiling/pin-3.2-81205-gcc-linux/"
pin_tool = "/home/misiker/Desktop/CDI-GCC/cdi/cdi-profiling/pin_trace/obj-intel64/itrace.so"
...
def run_profile(program):#itrace, pedata, output, program):
    ...
    pin_cmdline = pin_cmd + " -injection child -t " + pin_tool + " -i " +  itrace_file + addr + size + " -- ./" + program
    os.system(pin_cmdline)
